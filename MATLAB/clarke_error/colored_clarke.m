function [total, percentage] = colored_clarke(y, yp, horizon)
    ...
    set(gca, 'YLim', [0 400]);
    axis square;
    annotationText = ['Horizon: ', num2str(horizon), ' min'];
    annotation('textbox', [0.65, 0.795, 0.1, 0.1], 'String', annotationText, 'FitBoxToText', 'on', 'BackgroundColor', 'white','FontSize',14);
    set(h, 'color', 'white');
    set(gca, 'FontSize', 14);
