...
void init_patient() {
    ...
    float p_values[NUM_TUNING_PARAMS] = {86.1,5,basal,101.56,10,1.88,0.065,0.079,0.05,0.6,0.19,0.0304,0.0558,0.008,0.0570,0.9,0.82,0.01,2.7,0.0021,0.009,0.0079,1,225.59,0.047,0.0331,0.0164,0.0018,0.0182,0.0005,339};
